...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.created_at'
        db.add_column(u'beater_album', 'created_at',
        ...
        db.add_column(u'beater_album', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 20, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.created_at'
        db.delete_column(u'beater_album', 'created_at')

        # Deleting field 'Album.updated_at'
        db.delete_column(u'beater_album', 'updated_at')
