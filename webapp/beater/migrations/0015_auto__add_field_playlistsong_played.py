...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlaylistSong.played'
        db.add_column(u'beater_playlistsong', 'played',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlaylistSong.played'
        db.delete_column(u'beater_playlistsong', 'played')
