...
class FreshBeats(object):
	...
	def update_db(self, artist_filter=None, sha1_scan=False, id3_scan=False, purge=False, skip_verification=False):
...
def main(ingest, artist_filter, sha1_scan, id3_scan, report, validate_plan, apply_plan, new_randoms, purge, free, skip_verification):
	...
	try:
		...
		if ingest:
			f.update_db(artist_filter=artist_filter, sha1_scan=sha1_scan, id3_scan=id3_scan, purge=purge, skip_verification=skip_verification)
